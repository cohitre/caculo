Gem::Specification.new do |s|
  ...
  s.files = ["History.txt", "License.txt", "Manifest.txt", "README.txt", "lib/caculo.rb", "lib/caculo/version.rb", "lib/caculo/firefox.rb", "lib/caculo/internet_explorer.rb", "lib/caculo/javascript.rb", "lib/caculo/jquery.rb", "lib/caculo/safari.rb", "lib/caculo/unit.rb", "lib/assets/jquery-1.2.3.min.js", "test/test_caculo.rb", "test/test_helper.rb"]
  s.has_rdoc = true
